...
// @author       You
// 使用match去匹配登录页
// @match        https://auth.hnkjedu.cn/*
// @match        https://*.hnkjedu.cn/*
// @match        https://www.hvust.edu.cn/*
...
(function() {
    ...
    function createSettingsPanel() {
        ...
        // 面板内容
        panel.innerHTML = `
            <h3 style="text-align: center; margin-bottom: 20px; color: #343a40;"><a href="https://program.hnkjedu.cn/">设置参数</a></h3>
...
(function() {
    ...
    window.addEventListener("load", function(){
        ...
        // 获取网站域名并执行函数
        if (this.location.hostname == 'auth.hnkjedu.cn' && this.location.pathname == '/sso/auth') {
            // 填写学号
            document.querySelector(`input[name="stuName"]`).value = `${GM_getValue('username', 'null')}`;
            // 填写密码
            document.querySelector(`input[name="stuPwd"]`).value = `${GM_getValue('password', 'null')}`;
            // 点击登录
            document.getElementsByClassName('studentLogin-btn')[0].click()
        }
    });
})();